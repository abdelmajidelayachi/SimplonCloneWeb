    ...
    <nav class="bg-red-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <c:choose>
                                <c:when test="${current == 'brief'}">
                                    <a href="${pageContext.request.contextPath}/former/briefs"
                                       class="bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium">Briefs
                                    </a>

                                </c:when>
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/former/briefs"
                                       class="text-white hover:bg-red-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">Briefs
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            <c:choose>
                                <c:when test="${current == 'learner'}">
                                    <a href="${pageContext.request.contextPath}/former/learners"
                                       class="bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium">Learners
                                    </a>

                                </c:when>
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/former/learners"
                                       class="text-white hover:bg-red-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">Learners
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            <c:choose>
                                <c:when test="${current == 'promo'}">
                                    <a href="${pageContext.request.contextPath}/former/promo"
                                       class="bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium">Promo
                                    </a>

                                </c:when>
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/former/promo"
                                       class="text-white hover:bg-red-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">Promo
                                    </a>
                                </c:otherwise>
                            </c:choose>
                ...
                <div id="navbar-toggle" class="hidden md:block">
        ...
        <div class="md:hidden hidden" id="navbar-toggle-menu" >
                ...
                <c:choose>
                    <c:when test="${current == 'former'}">
                        <a href="${pageContext.request.contextPath}/admin/formers"
                           class="bg-red-700 text-white block px-3 py-2 rounded-md text-base font-medium">Formers
                        </a>

                    </c:when>
                    <c:otherwise>
                        <a href="${pageContext.request.contextPath}/admin/formers"
                           class="text-white hover:bg-red-500 hover:bg-opacity-75 block px-3 py-2 rounded-md text-base font-medium">Formers
                        </a>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${current == 'learner'}">
                        <a href="${pageContext.request.contextPath}/admin/learners"
                           class="bg-red-700 text-white block px-3 py-2 rounded-md text-base font-medium">Learners
                        </a>

                    </c:when>
                    <c:otherwise>
                        <a href="${pageContext.request.contextPath}/admin/learners"
                           class="text-white hover:bg-red-500 hover:bg-opacity-75 block px-3 py-2 rounded-md text-base font-medium">Learners
                        </a>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${current == 'promo'}">
                        <a href="${pageContext.request.contextPath}/admin/promos"
                           class="bg-red-700 text-white block px-3 py-2 rounded-md text-base font-medium">Promos
                        </a>

                    </c:when>
                    <c:otherwise>
                        <a href="${pageContext.request.contextPath}/admin/promos"
                           class="text-white hover:bg-red-500 hover:bg-opacity-75 block px-3 py-2 rounded-md text-base font-medium">Promos
                        </a>
                    </c:otherwise>
                </c:choose>
            </div>
